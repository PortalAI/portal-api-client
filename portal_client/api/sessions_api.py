...
from portal_client.rest import RESTResponseType
...
class SessionsApi:
    ...
    def create_async_session(
        ...
        _param = self._create_async_session_serialize(
            agent_id=agent_id,
    ...
    @validate_call
    def create_async_session_with_http_info(
        self,
        agent_id: StrictStr,
        text_prompt: StrictStr,
        files: Optional[List[Union[StrictBytes, StrictStr]]] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AsyncSessionResponse]:
        """Create Async Session
    ...
    @validate_call
    def create_async_session_without_preload_content(
        self,
        agent_id: StrictStr,
        text_prompt: StrictStr,
        files: Optional[List[Union[StrictBytes, StrictStr]]] = None,
    ...
    def _create_async_session_serialize(
        self,
        agent_id,
        text_prompt,
        files,
    ...
    @validate_call
    def create_session_from_replay(
        self,
        session_id: StrictStr,
        last_message_index: StrictInt,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type session_id: str
        :param last_message_index: (required)
        :type last_message_index: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_session_from_replay_serialize(
    ...
    @validate_call
    def create_session_from_replay_with_http_info(
        self,
        session_id: StrictStr,
        last_message_index: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    def create_session_from_replay_without_preload_content(
        self,
        session_id: StrictStr,
        last_message_index: StrictInt,
        _request_timeout: Union[
    ...
    def _create_session_from_replay_serialize(
        self,
        session_id,
        last_message_index,
        _request_auth,
        ...
        if last_message_index is not None:
            ...
            _query_params.append(('last_message_index', last_message_index))
    ...
    def subscribe_to_session(
        ...
        _param = self._subscribe_to_session_serialize(
            session_id=session_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def subscribe_to_session_with_http_info(
        self,
        session_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def subscribe_to_session_without_preload_content(
        self,
        session_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _subscribe_to_session_serialize(
        self,
        session_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/sessions/{session_id}/subscribe',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_async_session(
        ...
        _param = self._update_async_session_serialize(
            session_id=session_id,
            text_prompt=text_prompt,
            files=files,
            _request_auth=_request_auth,
    ...
    @validate_call
    def update_async_session_with_http_info(
        self,
        session_id: StrictStr,
        text_prompt: StrictStr,
        files: Optional[List[Union[StrictBytes, StrictStr]]] = None,
    ...
    @validate_call
    def update_async_session_without_preload_content(
        self,
        session_id: StrictStr,
        text_prompt: StrictStr,
        files: Optional[List[Union[StrictBytes, StrictStr]]] = None,
    ...
    def _update_async_session_serialize(
        self,
        session_id,
        text_prompt,
        files,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/sessions/{session_id}/async',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
