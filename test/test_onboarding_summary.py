...
class TestOnboardingSummary(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OnboardingSummary:
        """Test OnboardingSummary
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnboardingSummary`
        """
    ...
    def testOnboardingSummary(self):
        """Test OnboardingSummary"""
